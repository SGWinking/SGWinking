...
一张扫描图两万像素宽。整张丢给模型不行，人眼一块一块比对也不行。所以按实际流程拆成五个小工具，各管一步。

| 工具 | 管哪一步 |
|---|---|
| [相柳网格](https://github.com/SGWinking/xiangliu-grid) | 把大图切成带编号的方图块，修完按原位拼回去，接缝处做颜色校正 |
| [精卫](https://github.com/SGWinking/jingwei-patch) | AI 修好的局部图，自动算出它在原图里的位置和缩放，贴回去 |
| [白泽评审](https://github.com/SGWinking/baize-review) | 同一个位置出了好几版候选，打分排名 |
| [重明 DiffEye](https://github.com/SGWinking/chongming-diffeye) | 修复前后对比，圈出哪里多了、少了、挪了 |
| [工具箱启动台](https://github.com/SGWinking/dayun-mural-toolkit) | 看谁装了、谁在跑、什么版本，一键打开 |
